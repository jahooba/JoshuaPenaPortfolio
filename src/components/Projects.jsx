            ...
            <div className='grid-container'>
                ...
                <div className='grid-item'>
                    ...
                    <a href="https://youtu.be/MWOhm6TGCBI?si=06cs6EVHNgC2thE8" target="_blank" rel="noopener noreferrer">
                        <img src="/src/assets/metis_homepage.png" alt="Metis project screenshot" className="metis-image" />
                    </a>
                ...
                <div className='grid-item'>
                    ...
                    <a href='https://youtube.com/shorts/WvLc6aYeXYU' target="_blank" rel="noopener noreferrer">
                        <img src="/src/assets/dragon_hatcher_image.png" alt="Dragon Hatcher project screenshot" className="dragon-hatcher-image" />
                    </a>
